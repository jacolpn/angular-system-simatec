...
export class PageListComponent implements OnInit {
        ...
        this.poPageListService.getPlanningHTTP().subscribe({
            next: (value) => {
                ...
                this.planning.map((item: any) => {
                    ...
                    dataStartExecution.setDate(
                        dataStartExecution.getDate() + parseInt(item.runtime)
                    );

                    if (
                        dataStartExecution < dataHoje &&
    ...
    excludePlannig() {
        ...
        this.poPageListService.deletePlanning(selectedCandidate['id']).subscribe({
            next: (value) => {
    ...
    updateSituation() {      
        ...
        if (selectedCandidate && selectedCandidate['id']){
            this.poPageListService.putPlanning({
        ...
        switch (selectedCandidate['situation']) {
            case 'Concluido':
                console.log(
                    'ID do registro: ',
                    selectedCandidate['id'],
                    ', ',
                    selectedCandidate['situation']
                );
                selectedCandidate['situation'] = 'Em andamento';
            ...
            case 'Em andamento':
                ...
                selectedCandidate['situation'] = 'Concluido';
