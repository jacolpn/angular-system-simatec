...
export class PageListComponent implements OnInit {
    ...
    updateStartExecution(
        ...
        dataStartExecution.setDate(
            dataStartExecution.getDate() + parseInt(runtime)
        );
        status = 'No prazo';
        ...
        this.poDialog.confirm({
            ...
            confirm: () => {
                this.poPageListService
                    ...
                    .subscribe({
                        next: () => {
                            this.setSituation(selectedPlanning);
                        },
                        error: (err) => {
                            this.poNotification.warning('Não foi possível alterar a situação');
    ...
    private setSituation(selectedPlanning: any) {
